    ...
    <>
      ...
      <section className="panel-tight" style={{ paddingTop: '1rem' }}>
        <div className="vortex-grid">
          <motion.div className="card" initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <motion.div className="card" initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
          ...
          <motion.div className="card" initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
          ...
          <motion.div className="card" initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
      ...
      <section className="panel-tight">
        <motion.h2
          ...
          style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', marginBottom: '2.2rem' }}
        >
      ...
      <section className="panel-tight" style={{ alignItems: 'center', textAlign: 'center' }}>
        <Link to="/experience" className="contact-btn primary" style={{ marginInline: 'auto' }}>
          ← back to the experience timeline
        </Link>
      </section>

      <style>{`
        .vortex-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.6rem; max-width: 1180px; margin: 0 auto; }
        @media (max-width: 900px) { .vortex-grid { grid-template-columns: 1fr; } }
        .card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,185,143,0.18); border-radius: 18px; padding: 1.8rem; backdrop-filter: blur(6px); }
        ...
        .other-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.4rem; max-width: 1180px; margin: 0 auto; }
